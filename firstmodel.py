...
my_review = "it was a good movie, I enjoyed a lot..!, although the length could have been shorter, the director did a good job !!"

my_clean_review = review_to_words(my_review)
clean_train_reviews = []
...
my_clean_review2 = vectorizer.transform(my_clean_review)
 
np.asarray(test_data_features)
# Use the random forest to make sentiment label predictions
result = forest.predict(test_data_features)
result2 = forest.predict(my_clean_review2)
...
for i in xrange(10,15) :
 ...
 print result[i]
print "the prediction for the input review %s\n"%my_review
print "%d"%result[i]
